...
def _git_provenance() -> Dict[str, Any]:
    ...
    try:
        ...
        # Only tracked worktree changes (modified/deleted/staged) signal a dirty
        # tree. Untracked `??` entries — such as the batch of reports being
        # generated by the very run that called this helper — are the product,
        # not a code divergence, so they must not flag the run as non-reproducible.
        dirty = any(
