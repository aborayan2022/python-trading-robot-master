"""Crypto Mean Reversion backtest — CryptoMeanReversionStrategy against cached crypto data.
...
Run:  .venv/bin/python backtest_crypto_mean_rev.py --dry-run
      .venv/bin/python backtest_crypto_mean_rev.py
"""
...
def main() -> None:
    ...
    runner = MultiMarketBacktest(
        strategy_class=CryptoMeanReversionStrategy,
        strategy_name="crypto_mean_rev",
        symbols=symbols,
