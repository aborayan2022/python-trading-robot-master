"""US Mean Reversion backtest — USMeanReversionStrategy against cached US daily data.
...
Run:  .venv/bin/python backtest_us_mean_reversion.py --dry-run
      .venv/bin/python backtest_us_mean_reversion.py
"""
...
def main() -> None:
    ...
    runner = MultiMarketBacktest(
        strategy_class=USMeanReversionStrategy,
        strategy_name="us_mean_reversion",
        symbols=symbols,
