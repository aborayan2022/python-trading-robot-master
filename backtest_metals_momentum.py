"""Metals Momentum backtest — MetalsMomentumBreakout against cached metals daily data.
...
Run:  .venv/bin/python backtest_metals_momentum.py --dry-run
      .venv/bin/python backtest_metals_momentum.py
"""
...
def main() -> None:
    ...
    runner = MultiMarketBacktest(
        strategy_class=MetalsMomentumBreakout,
        strategy_name="metals_momentum",
        symbols=symbols,
